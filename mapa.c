...
void generujMape(int wiersze, int kolumny, int miny, int poziomTrudnosci) {
    ...
    continue;
        ...
        if (akcja == 'r') {
            ...
            wykonajRuch(mapa, widocznaMapa, wiersze, kolumny, x, y, akcja, &koniecGry, &odslonietePola);
        } else if (akcja == 'f') {
            wykonajRuch(mapa, widocznaMapa, wiersze, kolumny, x, y, akcja, &koniecGry, &odslonietePola);
        }
        ...
        obliczWynik(odslonietePola, poziomTrudnosci);
        if (odslonietePola == wiersze * kolumny - miny) {
    ...
    printf("Koniec gry!\n");
        zapiszLeaderboard(odslonietePola, poziomTrudnosci);
        najlepsiGracze();
